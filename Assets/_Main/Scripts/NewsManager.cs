...
{
    //NewsManager має викликатись єдиний раз на початку кожного місяця, тому найкраще енейблити його із загрузочної сцени і потім виключати на зовсім
    ...
    public void NewsClickHandler()
    {
        if (_isAnimationFinished)
        {
            ...
            _currentNewsPanel.transform.LeanMoveY(-Screen.height / 2, _newsPanelAnimationTime).setEaseOutQuart().setOnComplete(() => {
                ...
                //щоб вернути панель на своє місце
